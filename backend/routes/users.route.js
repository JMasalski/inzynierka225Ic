...
import {deleteUsers, getAllUsers, getUsersWithoutGroup, resetPassword} from "../controllers/users.controller.js";
...
usersRouter.post("/:id", authenticate,requireOnboarding,resetPassword)
