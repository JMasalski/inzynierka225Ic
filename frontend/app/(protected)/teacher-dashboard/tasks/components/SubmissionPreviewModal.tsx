            ...
            >
                <div className="flex flex-col h-full w-full bg-white rounded-lg overflow-hidden">
                    ...
                    <div className="flex flex-1 gap-4 p-4 min-h-0 overflow-hidden">
                        <div
                            className="flex-[3] border rounded-lg overflow-hidden flex flex-col min-h-0 bg-white shadow-sm">
                        ...
                        <div
                            className="flex-[2] flex flex-col border rounded-lg overflow-hidden min-h-0 bg-white shadow-sm">
                            <div className="bg-gray-50 px-4 py-2 border-b flex-shrink-0">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-right text-sm text-gray-600">
                                            ...
                                            <div className="flex items-center gap-2 justify-end mt-1">
                                                ...
                                                <span
                                                    className="font-medium">{Math.round(submission.maxMemory / 1024)}MB</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        submission.testResults.map((t: any, i: number) => (
                                            ...
                                            >
                                                ...
                                                <div className="space-y-2">
                                                    <div>
                                                        <span
                                                            className="font-semibold text-gray-700 text-sm block mb-1">Input:</span>
                                                        <code
                                                            className="bg-white px-3 py-2 rounded border block text-sm font-mono">
                                                            {t.input}
                                                        </code>
                                                    </div>
                                                    <div>
                                                        <span
                                                            className="font-semibold text-gray-700 text-sm block mb-1">Oczekiwany wynik:</span>
                                                        <code
                                                            className="bg-white px-3 py-2 rounded border block text-sm font-mono">
                                                            {t.expectedOutput}
                                                        </code>
                                                    ...
                                                    <div>
                                                        <span
                                                            className="font-semibold text-gray-700 text-sm block mb-1">Otrzymany wynik:</span>
                                                        <code
                                                            className={`px-3 py-2 rounded border block text-sm font-mono ${
                                                                t.passed
                                                    ...
                                                    {t.stderr && (
                                                        <div className="mt-3 pt-3 border-t border-red-200">
                                                            <span
                                                                className="font-semibold text-red-700 text-sm block mb-1">Błąd wykonania:</span>
                                                            <pre
                                                                className="bg-red-100 p-3 rounded text-xs overflow-auto max-h-32 border border-red-200 text-red-900 font-mono">
                                                                {t.stderr}
                                                            </pre>
                                                        </div>
                                                    )}
                                                    ...
                                                    {t.compile_output && (
                                                        <div className="mt-3 pt-3 border-t border-red-200">
                                                            <span
                                                                className="font-semibold text-red-700 text-sm block mb-1">Błąd kompilacji:</span>
                                                            <pre
                                                                className="bg-red-100 p-3 rounded text-xs overflow-auto max-h-32 border border-red-200 text-red-900 font-mono">
                                                                {t.compile_output}
                                                            </pre>
                                                    ...
                                                    <div
                                                        className="flex gap-4 text-sm text-gray-600 mt-3 pt-3 border-t">
